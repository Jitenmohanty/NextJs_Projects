...
const ProfileCard = () => {
  ...
  return (
    user && (
      <>
        <div className="flex gap-y-6 justify-center items-center flex-wrap">
          ...
          <div className="w-full flex justify-center">
            <Link
              href={"/logout"}
              className="bg-blue-500 hover:bg-red-700 font-bold rounded-xl px-4 py-2 inline-block  duration-150"
            >
              Logout
            </Link>
          </div>
